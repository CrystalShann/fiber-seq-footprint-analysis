#!/bin/bash
#SBATCH --job-name=silencer_part2
#SBATCH --time=24:00:00
#SBATCH --mem=180G
#SBATCH --cpus-per-task=3
#SBATCH --account=pi-spott
#SBATCH --partition=bigmem
#SBATCH --output=/project/spott/cshan/fiber-seq/results/logs/silencer_part2_%j.out
#SBATCH --error=/project/spott/cshan/fiber-seq/results/logs/silencer_part2_%j.err
...
export SILENCER_CHUNK_SIZE="${SILENCER_CHUNK_SIZE:-500}"
