...
OUTPUT_ROOT_DEFAULT = "/project/spott/cshan/fiber-seq/results/region_m6a_footprint_overlay"
TAD_BED = "/project/spott/cshan/fiber-seq/results/TADs_Fiber_MSP/pygenometracks_overlay/inputs/tads.bed"
TAD_BOUNDARY_BED = "/project/spott/cshan/fiber-seq/results/TADs_Fiber_MSP/TAD_fiber_tracks_inputs/tad_boundaries.bed"
CAGE_BED = "/project/spott/cshan/fiber-seq/results/TADs_Fiber_MSP/pygenometracks_overlay/inputs/cage_lcl_extended.bed.gz"
HIC_MATRIX = "/project/spott/cshan/annotations/HiC_GSE63525_LCL/GM12878_30.mcool::/resolutions/5000"
...
def write_tracks_ini(
    ...
    bigwig_root = (
        f"/project/spott/1_Shared_projects/LCL_Fiber_seq/FiberHMM/merged/combined/"
...
def main():
    ...
    write_tracks_ini(
        ...
        tad_title="TAD boundaries (Fiber MSP)" if use_tad_boundaries else "TADs (Arrowhead, GM12878)",
